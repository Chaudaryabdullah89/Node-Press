...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-20 md:pt-24 pb-12 md:pb-16">
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        {/* Header Section */}
        <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 border border-slate-100 shadow-sm mb-8 flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-center justify-between text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
            <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-gray-900 to-gray-700 text-white font-bold text-2xl md:text-3xl flex items-center justify-center overflow-hidden flex-shrink-0 shadow-md">
              {session?.user?.image ? (
                <Image
          ...
          <button
            ...
            className="w-full md:w-auto flex items-center justify-center gap-2 px-5 py-2.5 text-xs font-black uppercase tracking-widest text-red-500 hover:bg-red-50 rounded-full transition-colors border border-red-100"
          >
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-64 flex-shrink-0">
            <div className="bg-white rounded-xl md:rounded-2xl border border-slate-100 p-1.5 md:p-2 shadow-sm sticky top-20 md:top-28 flex flex-row md:flex-col overflow-x-auto md:overflow-x-visible no-scrollbar">
              {tabs.map((tab) => {
                const Icon = tab.icon;
                ...
                return (
                  <button
                    ...
                    className={`flex-shrink-0 md:flex-shrink-1 flex items-center gap-3 px-4 md:px-4 py-2.5 md:py-3 rounded-lg md:rounded-xl text-[10px] md:text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap ${
                      isActive
                        ? "bg-black text-white"
          ...
          <div className="flex-1 min-w-0">
            <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 border border-slate-100 shadow-sm min-h-[500px]">
              {/* Saved Tab */}
              {activeTab === "saved" && (
